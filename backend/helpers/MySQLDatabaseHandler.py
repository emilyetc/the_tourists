...
class MySQLDatabaseHandler(object):
    ...
    def __init__(self,MYSQL_USER,MYSQL_USER_PASSWORD,MYSQL_PORT,MYSQL_DATABASE,MYSQL_HOST = "localhost"):
        ...
        self.MYSQL_DATABASE = "info4300" if MySQLDatabaseHandler.IS_DOCKER else MYSQL_DATABASE
    ...
    def load_file_into_db(self,file_path  = None):
        ...
        sql_file = open(file_path,"r", encoding='utf-8', errors='replace') 
        #Rachel's note: added ", encoding='utf-8', errors='replace'" to line above due to utf encoding errors in init.sql
